...
impl Iterator for CatalogSalesArrow {
    ...
    fn next(&mut self) -> Option<Result<RecordBatch, ArrowError>> {
        ...
        let mut cs_sold_date: Vec<Option<i64>> = Vec::new();
        let mut cs_sold_time: Vec<Option<i64>> = Vec::new();
        let mut cs_ship_date: Vec<Option<i64>> = Vec::new();
        let mut cs_bill_customer: Vec<Option<i64>> = Vec::new();
        let mut cs_bill_cdemo: Vec<Option<i64>> = Vec::new();
        let mut cs_bill_hdemo: Vec<Option<i64>> = Vec::new();
        let mut cs_bill_addr: Vec<Option<i64>> = Vec::new();
        let mut cs_ship_customer: Vec<Option<i64>> = Vec::new();
        let mut cs_ship_cdemo: Vec<Option<i64>> = Vec::new();
        let mut cs_ship_hdemo: Vec<Option<i64>> = Vec::new();
        let mut cs_ship_addr: Vec<Option<i64>> = Vec::new();
        let mut cs_call_center: Vec<Option<i64>> = Vec::new();
        let mut cs_catalog_page: Vec<Option<i64>> = Vec::new();
        let mut cs_ship_mode: Vec<Option<i64>> = Vec::new();
        let mut cs_warehouse: Vec<Option<i64>> = Vec::new();
        let mut cs_item: Vec<Option<i64>> = Vec::new();
        let mut cs_promo: Vec<Option<i64>> = Vec::new();
        let mut cs_order_number: Vec<Option<i64>> = Vec::new();
        let mut cs_quantity: Vec<Option<i32>> = Vec::new();
        let mut cs_wholesale_cost: Vec<Option<i128>> = Vec::new();
        let mut cs_list_price: Vec<Option<i128>> = Vec::new();
        let mut cs_sales_price: Vec<Option<i128>> = Vec::new();
        let mut cs_ext_discount_amt: Vec<Option<i128>> = Vec::new();
        let mut cs_ext_sales_price: Vec<Option<i128>> = Vec::new();
        let mut cs_ext_wholesale_cost: Vec<Option<i128>> = Vec::new();
        let mut cs_ext_list_price: Vec<Option<i128>> = Vec::new();
        let mut cs_ext_tax: Vec<Option<i128>> = Vec::new();
        let mut cs_coupon_amt: Vec<Option<i128>> = Vec::new();
        let mut cs_ext_ship_cost: Vec<Option<i128>> = Vec::new();
        let mut cs_net_paid: Vec<Option<i128>> = Vec::new();
        let mut cs_net_paid_inc_tax: Vec<Option<i128>> = Vec::new();
        let mut cs_net_paid_inc_ship: Vec<Option<i128>> = Vec::new();
        let mut cs_net_paid_inc_ship_tax: Vec<Option<i128>> = Vec::new();
        let mut cs_net_profit: Vec<Option<i128>> = Vec::new();

        while self.current_row <= self.row_count && cs_sold_date.len() < self.batch_size {
        ...
        if cs_sold_date.is_empty() { return None; }
